...
def user_input_features():
    ...
    output = [a0,a1,a2,a3,a4,a5,a6,a7,a8]
    return output
...
colnames = ['Hcy','Sex','Total bilirubin','Albumin','Serum creatinine','INR',
                     'Bile acid','WBC','ESR']
outputdf = pd.DataFrame([outputdf], columns= colnames)

colnames_ = ['Hcy (μmol/L)' ,'Sex (1=male, 0=female)','Total bilirubin (μmol/L)','Albumin (g/L)','Serum creatinine (μmol/L)',
